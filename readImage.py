...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='best_detect.pt', help='model path(s)') #default 수정
...
if __name__ == "__main__":
    ...
    parser.add_argument('--imgH', type=int, default=64, help='the height of the input image') # 이미지 인식률 개선을 위해 default 수정
    parser.add_argument('--imgW', type=int, default=200, help='the width of the input image') # 이미지 인식률 개선을 위해 default 수정
    ...
    """ Model Architecture """
    parser.add_argument('--Transformation', type=str, default='TPS', help='Transformation stage. None|TPS') #required=True에서 default='TPS' 변경
    parser.add_argument('--FeatureExtraction', type=str, default='ResNet', help='FeatureExtraction stage. VGG|RCNN|ResNet') #required=True에서 default='ResNet' 변경
    parser.add_argument('--SequenceModeling', type=str, default='BiLSTM', help='SequenceModeling stage. None|BiLSTM') #required=True에서 default='BiLSTM' 변경
    parser.add_argument('--Prediction', type=str, default='Attn', help='Prediction stage. CTC|Attn') #required=True에서 default='Attn' 변경
